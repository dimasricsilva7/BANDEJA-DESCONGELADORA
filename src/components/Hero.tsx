    ...
    <section className="relative overflow-hidden bg-cream-50">
      <div className="container-app grid gap-10 py-8 sm:py-12 lg:grid-cols-2 lg:items-center lg:py-16">
        ...
        <div className="order-1 lg:order-2">
          <div className="relative mx-auto aspect-square w-full max-w-md overflow-hidden rounded-xl2 bg-white shadow-lift ring-1 ring-graphite-950/[0.05] sm:max-w-lg">
            <Image
              src={heroImage}
              alt="Bandeja de Descongelamento Rápido com Tampa sobre bancada de cozinha"
              fill
              priority

  ...
  return (
    <section className="relative overflow-hidden bg-cream-50">
      <div className="container-app py-8 sm:py-12 lg:py-16">
        <div className="mx-auto max-w-2xl animate-fadeUp text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-base text-graphite-700 sm:text-lg">
          ...
          {reviewStats.count > 0 && (
            <div className="mt-5 flex items-center justify-center gap-2 text-sm text-graphite-700">
          ...
          <TrustBar className="mt-7 justify-center" variant="compact" />
        </div>

        <div className="mx-auto mt-10 w-full max-w-3xl overflow-hidden rounded-xl2 bg-white shadow-lift ring-1 ring-graphite-950/[0.05]">
          <Image
            src={heroImage}
